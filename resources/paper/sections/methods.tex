...
\subsection{Bootstrapping error in DQV and DQV-Max}\label{sec:methods_be_dqv_dqvmax}
...
% TODO add explanation of Ensemble-DQV-Max-Tiny (ensemble only the Q
% function) once the data are ready
% TODO what about failed experiments with Bootstrapped versions of my
% agents? should I write and run them again?
