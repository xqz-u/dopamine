...
% NOTE maybe this sentence is not even necessary DONE it is alright
...
%% REVIEW should I introduce this section in the methods first?? DONE
%% it seems ok to Matthia too
...
%% formulations of the problem? DONE yes it is briefly mentioned in
%% the related work intro section
