...
class ImplicitQuantileAgentTest(absltest.TestCase):
    def setUp(self):
        ...
        self.ones_state = onp.ones((1,) + self.observation_shape + (self.stack_size,))
    ...
    def testReplayQuantileValueShape(self):
        ...
        for params in [agent.online_params, agent.target_network_params]:
            ...
            )(agent.network_def, params, batch_states, agent.num_tau_samples, rng_input)
    ...
    def testBeginEpisode(self):
        ...
        self.assertTrue(onp.array_equal(agent._observation, first_observation[:, :, 0]))
