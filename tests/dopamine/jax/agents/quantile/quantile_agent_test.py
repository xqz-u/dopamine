...
class JaxQuantileAgentTest(absltest.TestCase):
    ...
    def testShapesAndValues(self):
        ...
        self.assertEqual(net_outputs.logits.shape, (self.num_actions, self._num_atoms))
        ...
        onp.testing.assert_allclose(net_outputs.probabilities, expected_probabilities)
