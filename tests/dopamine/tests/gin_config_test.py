...
from dopamine.discrete_domains import atari_lib, run_experiment
...
class GinConfigTest(tf.test.TestCase):
    ...
    def testDefaultGinDqn(self):
        ...
        self.assertIsInstance(
            runner._agent.optimizer, tf.compat.v1.train.RMSPropOptimizer
        )
    ...
    def testDefaultDQNConfig(self):
        ...
        run_experiment.load_gin_configs(["dopamine/agents/dqn/configs/dqn.gin"], [])
        agent = run_experiment.create_agent(
            self.test_session(), atari_lib.create_atari_environment(game_name="Pong")
        )
    ...
    def testDefaultC51Config(self):
        ...
        run_experiment.load_gin_configs(["dopamine/agents/rainbow/configs/c51.gin"], [])
        agent = run_experiment.create_agent(
            self.test_session(), atari_lib.create_atari_environment(game_name="Pong")
        )
