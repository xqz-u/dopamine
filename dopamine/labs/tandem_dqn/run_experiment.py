...
class TandemRunner(run_experiment.Runner):
    ...
    def _run_one_phase(self, min_steps, statistics, run_mode_str, agent_type="active"):
    ...
    def _run_one_iteration(self, iteration):
        ...
        passive_num_episodes_eval, passive_average_reward_eval = self._run_eval_phase(
            statistics, "passive"
        )
    ...
    def _save_tensorboard_summaries(
        ...
        summary = tf.compat.v1.Summary(
            value=[
                ...
                tf.compat.v1.Summary.Value(
                    tag="Eval/ActiveNumEpisodes", simple_value=active_num_episodes_eval
                ),
                tf.compat.v1.Summary.Value(
