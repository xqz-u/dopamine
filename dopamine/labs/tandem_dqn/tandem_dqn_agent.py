...
class TandemDQNAgent(dqn_agent.JaxDQNAgent):
    ...
    def _build_networks_and_optimizer(self):
        ...
        self.passive_online_params = self.network_def.init(passive_rng, x=self.state)
                ...
                if (
                    ...
                    values = [
                        tf.compat.v1.Summary.Value(
                            tag="Losses/Active", simple_value=active_loss
                        ),
                        tf.compat.v1.Summary.Value(
                            tag="Losses/Passive", simple_value=passive_loss
                        ),
                    ]
    ...
    def unbundle(self, checkpoint_dir, iteration_number, bundle_dictionary):
        ...
        if bundle_dictionary is not None:
            ...
            self.passive_optimizer_state = bundle_dictionary["passive_optimizer_state"]
