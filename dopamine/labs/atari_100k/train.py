...
from dopamine.labs.atari_100k import atari_100k_rainbow_agent, eval_run_experiment
...
def create_agent(
    sess, environment, seed, summary_writer=None  # pylint: disable=unused-argument
):
    """Helper function for creating full rainbow-based Atari 100k agent."""
    return atari_100k_rainbow_agent.Atari100kRainbowAgent(
        num_actions=environment.action_space.n, seed=seed, summary_writer=summary_writer
    )
